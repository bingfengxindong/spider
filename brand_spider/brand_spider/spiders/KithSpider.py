...
class KithSpider(scrapy.Spider):
    name = "kith"
    start_urls = [
        "https://kith.com/collections/mens-accessories-hats?page=1",
        ...
        # "https://kith.com/collections/mens-accessories-bags?page=1",
        ...
        # "https://kith.com/collections/womens-accessories/bags?page=1",
        "https://kith.com/collections/kids-accessories?page=1",
